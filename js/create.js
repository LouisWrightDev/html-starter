...
function load_pattern() {
  ...
  bg = "https://github.com/LouisWrightDev/html-starter/tree/main/svg/" + pattern_menu.value + ".png";
  url = 'url("' + bg + '")';
...
function load_icon() {
  ...
  ic = "https://github.com/LouisWrightDev/html-starter/tree/main/svg/" + icon_menu.value + ".png";
