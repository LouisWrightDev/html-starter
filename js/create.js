...
function load_pattern() {
  ...
  // bg = "https://raw.githubusercontent.com/LouisWrightDev/html-starter/main/svg/" + pattern_menu.value + ".png";
  url = 'url("' + bg + '")';
...
function load_icon() {
  ...
  ic = "https://raw.githubusercontent.com/LouisWrightDev/html-starter/main/svg/" + icon_menu.value + ".png";
...
function show_preview() {
  ...
  card_url.innerHTML = '<a href="' + receive + query_string + '" target="_blank">Get the shareable link to your card</a>' + recipient;
}
...
icons_list = [ "Select Image", "Puffin1", "Puffin2", "Puffin3" ]
...
// patterns_list = [ "No Background Pattern", "Puffin1", "Puffin2", "Puffin3" ];
